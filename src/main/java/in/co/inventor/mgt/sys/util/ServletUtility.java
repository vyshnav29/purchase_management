...
import in.co.inventor.mgt.sys.controller.BaseCtl;
import in.co.inventor.mgt.sys.controller.IMSView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(IMSView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
