			...
			<div id="login-row" class="row justify-content ">
				<div id="login-column" class="col-md-12">
					<div class="row">
						...
						<div class="col">
							<input type="text" class="form-control" name="brandName" placeholder="Enter Brand Name..." value="<%=ServletUtility.getParameter("brandName", request)%>">
						</div>
						...
						<div class="col">
							<input type="submit" class="btn btn-info btn-md" value="<%=CategoryListCtl.OP_SEARCH%>">
						</div>
					</div>
				</div>
			</div>
		 ...
		 <%
			...
			<tr>
				...
				<td><a class="btn btn-primary"
					href="<%=IMSView.CATEGORY_CTL%>?id=<%=bean.getId()%>">Edit</a></td>
			</tr>
			<%} %>
		</tbody>
	</table>
