		...
		<div id="login-row" class="row justify-content align-items-center">
			<div id="login-column" class="col-md-6">
				<div id="login-box" class="col-md-12" style="margin-top: 30px;">
					<form id="login-form" class="form" action="<%=IMSView.BRAND_CTL%>"
						enctype="multipart/form-data" method="post">

						<jsp:useBean id="bean"
							class="in.co.inventor.mgt.sys.bean.BrandBean" scope="request"/>
						...
						<h3 class="text-info">Add Brand</h3>
						...
						<div class="form-group">
							...
							<textarea  name="description" placeholder="Enter Description..." class="form-control" rows="4" cols="5"
