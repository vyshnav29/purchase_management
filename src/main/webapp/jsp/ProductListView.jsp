...
<%@page import="in.co.inventor.mgt.sys.bean.ProductBean"%>
<%@page import="in.co.inventor.mgt.sys.bean.ProductBean"%>
<%@page import="java.util.List"%>
<%@page import="in.co.inventor.mgt.sys.controller.ProductListCtl"%>
...
<form id="login-form" class="form" action="<%=IMSView.PRODUCT_LIST_CTL%>"
	method="post">
	<div id="login">
			...
			<div id="login-row" class="row justify-content ">
				<div id="login-column" class="col-md-12">
					<div class="row">
						...
						<div class="col">
							<input type="submit" class="btn btn-info btn-md" value="<%=ProductListCtl.OP_SEARCH%>">
						</div>
					</div>
				</div>
			</div>
		 ...
		 <%
			...
			<tr>
				...
				<td><a class="btn btn-primary"
					href="<%=IMSView.PRODUCT_CTL%>?id=<%=bean.getId()%>">Edit</a></td>
			</tr>
			<%} %>
		</tbody>
	</table>
	...
	<table width="99%">
		<tr>
			<td><input type="submit" name="operation"
				class="btn btn-primary" value="<%=ProductListCtl.OP_PREVIOUS%>"
				<%=(pageNo == 1) ? "disabled" : ""%>></td>


			<td><input type="submit" name="operation"
				class="btn btn-primary" value="<%=ProductListCtl.OP_NEW%>"></td>
			<td><input type="submit" name="operation"
				value="<%=ProductListCtl.OP_DELETE%>" class="btn btn-primary"
				<%=(list.size() == 0) ? "disabled" : ""%>></td>
			
			<td align="right"><input type="submit" name="operation"
				class="btn btn-primary" value="<%=ProductListCtl.OP_NEXT%>"
